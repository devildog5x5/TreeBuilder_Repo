...
Begin VB.Form frmOptions 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Left            =   0
      TabIndex        =   13
      ToolTipText     =   "Switch betweeen Configuration sections."
      Top             =   0
      Width           =   9975
      _ExtentX        =   17595
      _ExtentY        =   14208
...
TBConfigFile = App.Path + "\" + "TreeBuilder.conf"
   Open TBConfigFile For Output As #1 '***File Open***
            ...
            'Print #1, "StopOnErrCheck=" + StopOnErrCheck.Value
...
'If RetrieveTreeCheck = 0 Then Text14.Text = ""
...
'If CustContCheck = 1 Then GoTo BypassTree1 'Tree Creates should still be available with Custom context selected. That is why I pullled this
'If CustomCheck = 1 Then GoTo CustLDIFStep1 'If Custom LDIF file is selected bypass the file creation.
   
'Start Tree Information
'If CheckAdd = 0 Then GoTo Step3
...
'If CustContCheck = 1 Then GoTo CCStep2
